...
// hex values that represent pixels
...
void Nokia5110_Init(void){
  ...
  delay = SYSCTL_RCGC2_R;               // wait till finish
  GPIO_PORTA_DIR_R |= 0xC0;             // output port
  GPIO_PORTA_AFSEL_R |= 0x2C;           // enable alt funct 
  GPIO_PORTA_AFSEL_R &= ~0xC0;          // disable alt funct 
  GPIO_PORTA_DEN_R |= 0xEC;             // enable digital I/O 
                                        // configure PA2 SSI
  GPIO_PORTA_PCTL_R = (GPIO_PORTA_PCTL_R&0xFF0F00FF)+0x00202200;
                                        // configure GPIO
  GPIO_PORTA_PCTL_R = (GPIO_PORTA_PCTL_R&0x00FFFFFF)+0x00000000;
  GPIO_PORTA_AMSEL_R &= ~0xEC;          // disable analog functionality 
  SSI0_CR1_R &= ~SSI_CR1_SSE;           // disable SSI
  SSI0_CR1_R &= ~SSI_CR1_MS;            // master 
                                        // configure for system clock
  SSI0_CC_R = (SSI0_CC_R&~SSI_CC_CS_M)+SSI_CC_CS_SYSPLL;  // clock divider for 3.33 MHz 
